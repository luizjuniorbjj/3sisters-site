    ...
    <footer className="bg-slate-900 text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <img
              ...
              className="h-16 w-auto bg-white rounded-lg p-2 self-start"
            />
            <p className="text-slate-400 text-sm leading-relaxed">
              3 Sisters Cleaning and Home Organizing — family-owned. Bonded, insured, and trusted across New York and California.
            </p>
            <div className="flex items-center gap-4 mt-2">
              <a
                ...
                aria-label="3 Sisters Cleaning and Home Organizing on Instagram"
              ...
              <a
                href="https://www.facebook.com/3sistersservices"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="3 Sisters Cleaning and Home Organizing on Facebook"
                className="text-slate-400 hover:text-white transition-colors duration-200"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                href="https://www.google.com/maps/place/?q=place_id:ChIJHd7qg_U_jaARfYZtUMdTLSY"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="3 Sisters Cleaning and Home Organizing on Google"
                className="text-slate-400 hover:text-white transition-colors duration-200"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                href="https://www.yelp.com/biz/3-sisters-cleaning-and-home-organizing-new-york"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="3 Sisters Cleaning and Home Organizing on Yelp"
                className="text-slate-400 hover:text-white transition-colors duration-200"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Col 2: Main Pages */}
          <div className="flex flex-col gap-4">
            <h4 className="font-outfit font-bold text-lg">Main Pages</h4>
          ...
          {/* Col 3: Information */}
          <div className="flex flex-col gap-4">
            <h4 className="font-outfit font-bold text-lg">Information</h4>
            <ul className="flex flex-col gap-3">
          ...
          {/* Col 4: Contact Us */}
          <div className="flex flex-col gap-4">
            <h4 className="font-outfit font-bold text-lg">Contact Us</h4>
            <div className="flex flex-col gap-3 text-sm text-slate-400">
              ...
              <div>
                <p className="text-slate-300 font-medium mb-1">Serving</p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-sm text-slate-400">
          <p>&copy; {currentYear} 3 Sisters Cleaning and Home Organizing. All rights reserved.</p>
          <p>
            Powered by{' '}
            <a
              href="https://clawtobusiness.com"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white transition-colors duration-200 underline-offset-4 hover:underline"
            >
              OpenClaw To Business
            </a>
          </p>
        </div>
      </div>
